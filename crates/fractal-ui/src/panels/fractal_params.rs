...
impl FractalParamsPanel {
    ...
    fn show_mandelbulb_params(ui: &mut Ui, params: &mut fractal_core::FractalParams) -> bool {
        ...
        ui.horizontal(|ui| {
            ui.label("Power:");
            if ui.add(egui::Slider::new(&mut params.power, 1.0..=16.0)).changed() {
                changed = true;
            }
        });
        ...
        ui.horizontal(|ui| {
            ui.label("Bailout:");
            if ui.add(egui::Slider::new(&mut params.bailout, 1.0..=8.0)).changed() {
                changed = true;
            }
        });
    ...
    fn show_julia_params(ui: &mut Ui, params: &mut fractal_core::FractalParams) -> bool {
        ...
        ui.horizontal(|ui| {
            ui.label("x:");
            if ui.add(egui::DragValue::new(&mut params.julia_c[0])
                .speed(0.01)
                .range(-2.0..=2.0))
                .changed() {
                changed = true;
        ...
        ui.horizontal(|ui| {
            ui.label("y:");
            if ui.add(egui::DragValue::new(&mut params.julia_c[1])
                .speed(0.01)
                .range(-2.0..=2.0))
                .changed() {
                changed = true;
        ...
        ui.horizontal(|ui| {
            ui.label("z:");
            if ui.add(egui::DragValue::new(&mut params.julia_c[2])
                .speed(0.01)
                .range(-2.0..=2.0))
                .changed() {
                changed = true;
    ...
    fn show_mandelbox_params(ui: &mut Ui, params: &mut fractal_core::FractalParams) -> bool {
        ...
        ui.horizontal(|ui| {
            ui.label("Scale:");
            if ui.add(egui::Slider::new(&mut params.scale, -3.0..=3.0)).changed() {
                changed = true;
            }
        });
        ...
        ui.horizontal(|ui| {
            ui.label("Fold Limit:");
            if ui.add(egui::Slider::new(&mut params.fold_limit, 0.5..=2.0)).changed() {
                changed = true;
            }
        });
        ...
        ui.horizontal(|ui| {
            ui.label("Min Radius²:");
            if ui.add(egui::Slider::new(&mut params.min_radius_sq, 0.01..=1.0)).changed() {
                changed = true;
            }
        });
    ...
    fn show_sierpinski_params(ui: &mut Ui, params: &mut fractal_core::FractalParams) -> bool {
        ...
        ui.horizontal(|ui| {
            ui.label("Scale:");
            if ui.add(egui::Slider::new(&mut params.scale, 1.5..=3.0)).changed() {
                changed = true;
            }
        });
